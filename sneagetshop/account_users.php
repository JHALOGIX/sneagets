...
<head>
    ...
    <title>Sneaget - Account Users</title>
    <!-- Bootstrap CSS -->
            ...
            <div class="container-fluid dashboard-content"> 
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        ...
                        $select = "SELECT * FROM sneaget_shop_users_registrations where users_id = $users_id";
                        $query = mysqli_query($conn, $select);
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered first">
                                        ...
                                        <tbody>
                                            <?php
                                            require_once('config.php');
                                            $select = "SELECT * FROM sneaget_shop_orders where users_id = $users_id";
                                            $query = mysqli_query($conn, $select);
                                            $i = 1;
                                            while ($res = mysqli_fetch_assoc($query)) {
                                            ?>
                                            <tr>
                                                ...
                                                <td>ZMW. <?php echo $res['total_amount'];?></td>
                                            </tr>
                                            <?php } ?>
                                        </tbody>
                                        <tfoot>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered first">
                                        ...
                                        <tbody>
                                            <?php
                                            require_once('config.php');
                                            // $select = "SELECT * FROM sneaget_shop_orders_detail";
                                            $select = "SELECT sneaget_shop_orders_detail.*, sneaget_shop_orders.orders_id FROM sneaget_shop_orders_detail JOIN sneaget_shop_orders ON sneaget_shop_orders_detail.orders_id = sneaget_shop_orders.orders_id WHERE users_id = $users_id";
                                            $query = mysqli_query($conn, $select);
                                            $i = 1;
                                            while ($res = mysqli_fetch_assoc($query)) {
                                            ?>
