...
<head>
    ...
    <title>Sneaget - Add Product</title>
    <!-- Bootstrap CSS -->
...
"></i>Orders</a>
    ...
    <input id="inputProductPrice" type="number" name="product_price" required="" placeholder="Enter product price" autocomplete="off" class="form-control">
</div>
