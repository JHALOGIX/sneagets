...
<head>
    ...
    <title>Sneaget Stores - View Product</title>
    <!-- Bootstrap CSS -->
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered first">
                                        ...
                                        <tbody>
                                            ...
                                            $select = "SELECT sneaget_shop_product.*, sneaget_shop_category.category_name FROM sneaget_shop_product JOIN sneaget_shop_category ON sneaget_shop_product.product_category = sneaget_shop_category.category_id";
                                            ...
                                            <tr>
                                                ...
                                                <td>ZMW. <?php echo $res['product_price'];?></td>
                                                <td>
                                                	<?php
