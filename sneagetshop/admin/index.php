...
<head>
    ...
    <title>Sneaget Admin - Login</title>
    <!-- Bootstrap CSS -->
...
<body>
    ...
    <div class="splash-container">
        <div class="card ">
            <div class="card-header text-center"><a href="#"><h2 class="text-primary">Sneaget Stores</h2></a><span class="splash-description">Please enter your user information.</span></div>
            <div class="card-body">
