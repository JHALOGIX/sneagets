        ...
        <!-- <div class="dashboard-wrapper"> -->
            <div class="container-fluid dashboard-content">    
                ...
                <div class="row mx-5">
                    ...
                    <?php
                    require_once('config.php');
                    $select = "SELECT * FROM sneaget_shop_product where product_category = ".$_GET['category'];
                    $query = mysqli_query($conn, $select);
                    while ($res = mysqli_fetch_assoc($query)) {
                    ?>
                        ...
                        <div class="product-thumbnail rounded">
                            <div class="product-img-head">
                                <div class="product-img">
                                    ...
                                    ?>
                                    <img src="uploads/<?php echo $file_array[0];?>" class="img-fluid" style="width: 250px; height: 200px;">
                                </div>
                            </div>
                            <div class="product-content">
                                <div class="product-content-head">
                                    <h3 class="product-title"><?php echo $res['product_name'];?></h3>
                                    <div class="product-price">ZMW <?php echo $res['product_price'];?></div>
                                </div>
