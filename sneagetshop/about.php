                    	...
                    	<div class="card">
                    		<div class="card-body">
                    			<div class="text-secondary font-italic m-3">
                                    <p>
                                        The sneaget Shop was founded by a team of passionate and dedicated bakers who are committed in baking the most delicious sneagets and pastries around. Using only the freshest ingredients we can find, you can be sure that you are served the best quality sneaget you can ever have.
                                    </p>
                                    <p>
                                        We have evolved to become one of a premium distributor and wholesaler for sneagets and pastries to some well known resturants, cafes, supermart, hotels and bakery.
                                    </p>
                                    <p>
                                        Our online store is a leading online shop in Singapore providing sneagets and gifts deliveries within Singapore. We provide competitive prices, good after sales services and on-time delivery.
                                    </p>
                                    <p>
                                        The sneaget Shop provides same day delivery service seven days a week, including Sunday, within Singapore to provide a high level of customer service.
                                    </p>
                                    <p>
                                        Bon Appetite!!
                                    </p>
                                    <p>
                                        The sneaget Shop Team
                                    </p>
                                </div>
                    		</div>
                    	</div>
