...
<head>
    ...
    <title>Sneaget - Product Details</title>
    <!-- Bootstrap CSS -->
        ...
        <!-- <div class="dashboard-wrapper"> -->
            <div class="container-fluid dashboard-content">    
                ...
                <div class="row mx-5">
                    ...
                    $select = "SELECT * FROM sneaget_shop_product where product_id = $product_id";
                    $query = mysqli_query($conn, $select);
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 pl-xl-0 pl-lg-0 pl-md-0 border-left m-b-30 d-flex">
                                <div class="product-details p-4">
                                    <div class="border-bottom pb-3 mb-3">
                                        ...
                                        <h3 class="mb-0 text-primary">ZMW <?php echo $res['product_price'];?></h3>
                                    </div>
                            ...
                            <div class="item">
                                <div class="card h-100">
                                    <div class="card-body">
                                        ...
                                        <a href="shop.php?category=<?php echo $res['category_id'];?>"><img class="card-img" src="uploads/<?php echo $res['category_image'];?>"style="width: 250px; height: 300px;"></a>
                                    </div>
